...
print(f"Frame diagonal: {frame_diagonal}")
...
while cap.isOpened():
    ...
    # Process every 5th frame for SAHI detection
    if frame_count % 5 == 0:
...
# Print the duration
#print(f"Length of the video: {duration} seconds")

# Optional: You can convert the duration to a more readable format (e.g., minutes and seconds)
minutes = int(duration // 60)
seconds = int(duration % 60)
print(f"Length of the video: {minutes} minutes and {seconds} seconds")