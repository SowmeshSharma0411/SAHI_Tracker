...
"""# Add the directory containing custom_byte_tracker to the system path
sys.path.append("C:\\Users\\aimlc\\OneDrive\\Desktop\\Sowmesh\\mot_ultralytics\\custom_ultralytics\\custom_ultralytics\\trackers")

# Now you can import custom_byte_tracker

from custom_byte_tracker import BYTETracker  # or whatever class/function you need
"""
...
video_path = "C:\\Users\\aimlc\\Downloads\\videoplayback.mp4"
