    ...
    while True:
        ...
        for results in batch_results:
            ...
            for i in range(len(ids_list)):
                if ids_list[i] in track_hist_dict.keys():
                    track_hist_dict[ids_list[i]].append(results.boxes.xywhn[i].tolist())
                else:
                    track_hist_dict[ids_list[i]] = [results.boxes.xywhn[i].tolist()]
